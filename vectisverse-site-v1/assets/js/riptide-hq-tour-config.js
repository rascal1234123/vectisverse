window.RIPTIDE_HQ_TOUR = {
  ...
  defaultFov: 75,
  nodes: [
    { id:'01', quarter:'Q2', label:'Team Area', image:'assets/riptide-hq/hq-node-01-beta.svg?v=beta2', mobile:'assets/riptide-hq/hq-node-01-beta.svg?v=beta2', previous:null, next:'02' },
